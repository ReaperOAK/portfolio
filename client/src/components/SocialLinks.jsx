...
// helper to build allowed full URLs from stored path values
...
function SocialLinks({ className = '' }) {
  ...
  <a href={buildUrl('github', socials.github)} target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="hover:text-primary transition-colors focus:outline-none focus:ring-2 focus:ring-primary rounded">
  ...
  <a href={buildUrl('linkedin', socials.linkedin)} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:text-primary transition-colors focus:outline-none focus:ring-2 focus:ring-primary rounded">
      ...
      {socials.instagram && (
  <a href={buildUrl('instagram', socials.instagram)} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:text-primary transition-colors focus:outline-none focus:ring-2 focus:ring-primary rounded">
